  ...
  return (
    <>
      ...
      <ServicePracticeHero
        ...
        imageSrc="/media/SalesforceServiceLine.png"
        imageFit="contain"
        imageBackground="#FFFFFF"
      >
        Maximize CRM potential and <HeroHighlight>drive growth</HeroHighlight> with expert Salesforce solutions.
      </ServicePracticeHero>
        ...
        <div className="ms-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="relative overflow-hidden rounded-2xl" style={{ height: "420px", backgroundColor: "#FFFFFF", boxShadow: "0 20px 60px rgba(0,31,101,0.12)" }}>
              ...
              <img src="/media/SalesforceServiceLine.png" alt="Salesforce consulting services" style={{ width: "100%", height: "100%", objectFit: "contain", objectPosition: "center", padding: "3rem" }} />
            </div>
            <div>
