...
const SERVICES = [
  {
    ...
    body: [
      {
        text: "Where should your workloads live? What does a phased migration look like for your organization? How do you balance cost, performance, and security across environments?",
        bold: false,
      },
      {
        text: "Our team builds practical cloud roadmaps grounded in your current infrastructure, budget, and business objectives — so you can",
        bold: false,
      },
      {
        text: "move to the cloud with confidence, not guesswork.",
        bold: true,
      },
    ],
  },
  {
    ...
    body: [
      {
        text: "Moving to the cloud is more than a lift-and-shift exercise.",
        bold: true,
      },
      {
        text: "Our engineers assess your existing environment, design the target architecture, and execute migrations that minimize downtime and risk — whether you're moving from on-prem servers, modernizing a legacy data center, or consolidating across cloud providers.",
        bold: false,
      },
    ],
  },
  {
    ...
    body: [
      {
        text: "Cloud environments require continuous attention. Costs drift. Performance degrades. Security postures change.",
        bold: false,
      },
      {
        text: "We monitor, optimize, and govern your cloud infrastructure on an ongoing basis,",
        bold: true,
      },
      {
        text: "keeping your environment secure, right-sized, and aligned with where your business is heading — not where it was six months ago.",
        bold: false,
      },
    ],
  },
...
const LEFT_TOOLS = [
  {
    ...
    description:
      "M&S is an AWS Well-Architected Partner. We design workloads that adhere to the five pillars of the Well-Architected Framework: Operational Excellence, Security, Reliability, Performance Efficiency, and Cost Optimization.",
  },
  {
    name: "Microsoft Azure",
    description:
      "Azure infrastructure design, deployment, and optimization — including Entra ID, AKS, Azure AI services, and hybrid connectivity through Azure Arc and Azure Stack.",
  },
  {
    name: "Google Cloud Platform",
    description:
      "GCP workload design and implementation across Compute Engine, GKE, BigQuery, and Cloud Run — with a focus on data-intensive and analytics-driven architectures.",
  },
  {
    name: "DevSecOps & CI/CD",
    description:
      "Security integrated at every stage of the delivery pipeline. We implement automated testing, vulnerability scanning, and compliance gates so your deployments are safe by design — not bolted on after the fact.",
  },
];
...
const RIGHT_TOOLS = [
  {
    ...
    description:
      "Container strategy, Kubernetes cluster design, and workload migration. We help you move from monolithic deployments to resilient, scalable container-based architectures managed at enterprise scale.",
  },
  {
    name: "Infrastructure as Code",
    description:
      "Terraform, AWS CloudFormation, and Bicep-based infrastructure automation. We codify your cloud environments so they're repeatable, version-controlled, and auditable.",
  },
  {
    name: "Hybrid & Multi-Cloud",
    description:
      "Many organizations can't — or shouldn't — move everything to a single cloud. We design hybrid architectures that bridge your on-premises investments with public cloud capabilities, without sacrificing security or manageability.",
  },
  {
    name: "Cloud Security & Compliance",
    description:
      "Shared responsibility doesn't mean shared confusion. We establish clear security boundaries, implement cloud-native controls, and validate compliance postures for FedRAMP, HIPAA, SOC 2, and NIST frameworks.",
  },
];
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative hidden lg:block" style={{ height: "480px" }}>
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/media/dc-metro-station-scaled-1.webp"
                  alt=""
                  aria-hidden="true"
                  style={{
                    width: "100%",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <img
                ...
                alt="Modern cloud infrastructure data center"
            ...
            <div>
              ...
              <p
                ...
                style={{ fontSize: "clamp(1.05rem, 1.8vw, 1.2rem)", lineHeight: 1.75, color: "#2D3748", marginBottom: "1.5rem" }}
              >
                Our experts have over 20 years of experience designing and implementing personalized cloud strategies that modernize businesses from the ground up. We specialize in hybrid and multi-cloud environments — meeting you where you are and taking you exactly where you want to go.
              </p>
              <p
                className="font-sans"
              ...
              >
                Let us{" "}
                <strong>leverage the right cloud technologies to optimize your operations and deliver the maximum return on your investment.</strong>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="ms-container">
          <div className="mb-14">
            ...
            <p className="font-sans" style={{ fontSize: "1rem", color: "#4A5568", fontStyle: "italic" }}>
              Our expert cloud consultants can help you with&hellip;
            </p>
          </div>
      ...
      <PracticeAreaAccordion
        heading="Cloud Technologies We Work With"
        leftTools={LEFT_TOOLS}
        rightTools={RIGHT_TOOLS}
        bgImage="/media/server-room.jpg"
      />
