...
const SERVICES = [
  {
    ...
    body: [
      {
        text: "Where are you exposed? What's actually protecting your most critical assets? Most organizations don't know until something goes wrong.",
        bold: false,
      },
      {
        text: "We conduct thorough security assessments — reviewing your architecture, policies, controls, and threat landscape — and deliver",
        bold: false,
      },
      {
        text: "a prioritized security roadmap grounded in real risk, not compliance checkboxes.",
        bold: true,
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        text: "We design and implement IAM programs that govern who can access what — and under what conditions — across your on-premises systems, cloud environments, and third-party applications. From Zero Trust architecture to privileged access management, we make sure your controls match your risk.",
        bold: false,
      },
    ],
  },
  {
    ...
    body: [
      {
        text: "Security compliance is necessary — but it's not sufficient. We help you satisfy regulatory requirements while building controls that actually protect your operations,",
        bold: false,
      },
      {
        text: "not just satisfy an auditor.",
        bold: true,
      },
      {
        text: "We have deep experience with FedRAMP, NIST 800-53, HIPAA, CMMC, and SOC 2 frameworks — across both commercial and government environments.",
        bold: false,
      },
    ],
  },
...
const LEFT_TOOLS = [
  {
    ...
    description:
      "Endpoint protection, threat detection, and SIEM implementation using Microsoft Defender for Endpoint and Microsoft Sentinel — with custom analytics rules, playbooks, and incident response workflows.",
  },
  {
    name: "Okta & Microsoft Entra ID",
    description:
      "Identity platform implementation and integration — single sign-on, multi-factor authentication, conditional access policies, and lifecycle management across your application portfolio.",
  },
  {
    name: "SailPoint",
    description:
      "Identity governance and administration on SailPoint IdentityNow and IdentityIQ — certifications, role management, and provisioning workflows that keep your access model clean over time.",
  },
  {
    name: "CrowdStrike",
    description:
      "Falcon platform deployment and configuration for endpoint detection and response (EDR), threat hunting, and identity protection across your enterprise environment.",
  },
];
...
const RIGHT_TOOLS = [
  {
    ...
    description:
      "Design and implementation of Zero Trust network architectures — micro-segmentation, device trust, least-privilege access, and continuous validation across users, devices, and workloads.",
  },
  {
    name: "SIEM & SOC Operations",
    description:
      "Security information and event management configuration, log source onboarding, use case development, and alert tuning — building or maturing a SOC capability that surfaces real threats.",
  },
  {
    name: "Vulnerability Management",
    description:
      "Continuous vulnerability scanning, prioritization, and remediation tracking. We help you move from point-in-time assessments to a sustainable program that keeps pace with your environment.",
  },
  {
    name: "Compliance Frameworks",
    description:
      "FedRAMP, NIST 800-53, CMMC, HIPAA, and SOC 2 readiness and assessment support. We help you understand your control gaps, close them efficiently, and maintain evidence of compliance over time.",
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        <img
          src="/media/graphics/geometric-6.png"
          alt=""
          aria-hidden="true"
          style={{
            position: "absolute",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative hidden lg:block" style={{ height: "480px" }}>
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/media/getty-images-snqclgLZaoU-unsplash-scaled.jpg"
                  alt=""
                  aria-hidden="true"
                  style={{
                    width: "100%",
        ...
        <div className="ms-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/media/getty-images-IoG8mpVg8yY-unsplash-scaled.jpg"
                alt="M&S Consulting cybersecurity team"
        ...
        <div className="ms-container">
          <div className="mb-14">
            ...
            <p className="font-sans" style={{ fontSize: "1rem", color: "#4A5568", fontStyle: "italic" }}>
              Our expert security consultants can help you with&hellip;
            </p>
          </div>
      ...
      <PracticeAreaAccordion
        heading="Security Technologies We Work With"
        leftTools={LEFT_TOOLS}
        rightTools={RIGHT_TOOLS}
        bgImage="/media/light-trails.jpg"
      />
