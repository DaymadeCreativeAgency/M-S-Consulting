...
const SERVICES = [
  {
    ...
    body: [
      {
        text: "Which enterprise systems are right for your organization? How do you ensure they align with your processes rather than forcing your team to work around them?",
        bold: false,
      },
      {
        text: "Our consultants have deep implementation experience across the leading ERP and business platforms. We help you select, configure, and deploy",
        bold: false,
      },
      {
        text: "solutions that fit your workflows — not the other way around.",
        bold: true,
      },
    ],
  },
  {
    ...
    body: [
      {
        text: "Off-the-shelf software doesn't always solve the right problem.",
        bold: true,
      },
      {
        text: "When you need something built specifically for your business — a customer-facing application, an internal productivity tool, or a proprietary workflow engine — our development team builds it with long-term maintainability in mind.",
        bold: false,
      },
      {
        text: "We deliver working software on schedule, backed by M&S's 20-year track record of delivery.",
        bold: false,
      },
    ],
  },
  {
    ...
    body: [
      {
        text: "Enterprise software is only as valuable as how well your team uses it. After implementation,",
        bold: false,
      },
      {
        text: "we stay engaged to ensure your systems stay connected, performant, and aligned with how your business evolves.",
        bold: true,
      },
      {
        text: "From API integrations to user training and ongoing support, we keep your enterprise stack running at full effectiveness.",
        bold: false,
      },
    ],
  },
...
const LEFT_TOOLS = [
  {
    name: "Salesforce",
    description:
      "CRM configuration, custom object development, Sales Cloud, Service Cloud, and Marketing Cloud implementations tailored to your sales and service operations.",
  },
  {
    name: "SAP",
    description:
      "SAP ERP and S/4HANA implementations, migrations, and optimizations. We bring deep functional and technical expertise across finance, supply chain, and HR modules.",
  },
  {
    name: "Oracle",
    description:
      "Oracle Cloud Applications and E-Business Suite implementations. Our team guides you through complex Oracle deployments with precision and minimal disruption.",
  },
  {
    name: "Microsoft Dynamics",
    description:
      "Dynamics 365 configuration and integration across Business Central, Finance & Operations, and Customer Engagement — connected to your broader Microsoft ecosystem.",
  },
];
...
const RIGHT_TOOLS = [
  {
    name: "ServiceNow",
    description:
      "ITSM, HRSD, and custom workflow automation on the ServiceNow platform. We design and deploy solutions that reduce manual work and surface the right information at the right time.",
  },
  {
    name: "Power Platform",
    description:
      "Low-code applications, automated workflows, and data visualizations using Power Apps, Power Automate, and Power BI — extending your Microsoft investment without heavy development.",
  },
  {
    name: "Custom Application Development",
    description:
      "Web, mobile, and desktop applications built to your specifications. We use modern frameworks and follow engineering best practices to deliver software that scales with your business.",
  },
  {
    name: "API & Systems Integration",
    description:
      "Connect your enterprise systems so data flows where it's needed. We design and implement integration architectures that eliminate silos and reduce manual data entry.",
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        <img
          src="/media/graphics/geometric-2.png"
          alt=""
          aria-hidden="true"
          style={{
            position: "absolute",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative hidden lg:block" style={{ height: "480px" }}>
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/media/getty-images-jlY4MGjGT68-unsplash-1-scaled.jpg"
                  alt=""
                  aria-hidden="true"
                  style={{
                    width: "100%",
        ...
        <div className="ms-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/media/curated-lifestyle-kGYWfeL8_64-unsplash-scaled.jpg"
                alt="M&S Consulting enterprise applications team"
            ...
            <div>
              ...
              >
                Enterprise applications are advanced digital tools that can transform the way your business operates. But the key to unlocking their full potential lies in{" "}
        ...
        <div className="ms-container">
          <div className="flex flex-col items-center text-center" style={{ maxWidth: "820px", margin: "0 auto" }}>
            ...
            >
              ...
              or build a custom application from the ground up — our team is here to be your expert guide and trusted partner.
            </p>
            <Link
              href="/contact"
        ...
        <div className="ms-container">
          <div className="mb-14">
            ...
            <p className="font-sans" style={{ fontSize: "1rem", color: "#4A5568", fontStyle: "italic" }}>
              Our expert consultants can help you with&hellip;
            </p>
          </div>
      ...
      <PracticeAreaAccordion
        heading="Enterprise Technologies We Work With"
        leftTools={LEFT_TOOLS}
        rightTools={RIGHT_TOOLS}
        bgImage="/media/ai-rods.jpg"
      />
