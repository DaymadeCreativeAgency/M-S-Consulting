...
const STATIC_PAGES: SearchResultItem[] = [
  ...
  { type: "page", title: "ERP Consulting Services", description: "ERP implementation, optimization, integration, and support", href: "/enterprise-resource-planning" },
  { type: "page", title: "Detailed Ticket History Lite Privacy Policy", description: "Privacy policy and EULA for M&S Atlassian apps", href: "/detailed-ticket-history-lite-privacy-policy" },
