...
description: >-
  Welcome back to Human-Coded, the podcast exploring the dynamic intersection of technology
  and people. In today’s episode, we dive into the foundational components of machine learning
  as part of our ongoing AI Roadmap series. Hosts Quinn Brewer, Leo Tomei, and Jay Mason break
  down the world of classification apps, prediction models, and computer vision. From email
  spam filters to fraud detection and customer segmentation, we explore how classification
  apps transform industries. We also discuss...
...
readTime: 6 min read
coverImage: "/media/podcast/episode-007.png"
buzzsproutEpisodeId: "16141641"
buzzsproutEmbedUrl: "https://www.buzzsprout.com/2377743/episodes/16141641-human-coded-007-how-machine-learning-forecasts-the-future?client_source=small_player&iframe=true&player=small"
---
